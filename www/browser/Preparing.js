/*
    ...
    (function() {
        ...
        window.resolveLocalFileSystemURL = function(url, win, fail) {
            ...
            fileSystemIsNowRequired(function(granted) {
                if (!granted) {
                    if (fail) fail(new FileError(FileError.SECURITY_ERR));
                    return false;
                }
        ...
        function fileSystemIsNowRequired(granted) {
            if (quotaWasRequested) {
                granted(true);
                return;
            }
            window.initPersistentFileSystem(PERSISTENT_FS_QUOTA, function(howmany) {
                if (howmany > 0) {
